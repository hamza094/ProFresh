(window['webpackJsonp'] = window['webpackJsonp'] || []).push([
  ...
  \********************************************************************************************************************************************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _SubscriptionChecker_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
        ...
        /* harmony default export */ __webpack_exports__['default'] = {
          ...
          methods: _objectSpread(
            _objectSpread(
              {},
              Object(vuex__WEBPACK_IMPORTED_MODULE_0__['mapMutations'])('project', [
                'updateNotes',
                'noteScore',
                'updateScore',
                'detachMember',
            ...
            {},
            {
                ...
                axios
                  ...
                  ['catch'](function (error) {
                    ...
                    if (
                      ...
                      _this3.$vToastify.warning(
                        ((_error$response3 = error.response) === null ||
                        _error$response3 === void 0 ||
                        (_error$response3 = _error$response3.data) === null ||
                        _error$response3 === void 0
                          ? void 0
                          : _error$response3.error) || 'An unexpected error occurred.',
                      );
                    }
                  });
              },
              removeMember: function removeMember(id, member) {
                ...
                this.sweetAlert('Yes, Remove Member').then(function (result) {
                  if (result.value) {
                    axios
                      .get('/api/v1/projects/' + _this4.slug + '/remove/member/' + id, {
                        useProgress: true,
                      })
                      .then(function (response) {
                      ...
                      ['catch'](function (error) {
                        ...
                        _this4.$vToastify.warning(
                          ((_error$response4 = error.response) === null ||
                          _error$response4 === void 0 ||
                          (_error$response4 = _error$response4.data) === null ||
                          _error$response4 === void 0
                            ? void 0
                            : _error$response4.error) || 'Failed to remove the member. Try again.',
                        );
                      });
                  }
                });
              ...
              cancelRequest: function cancelRequest(userId) {
                ...
                this.sweetAlert('Yes, cancel request').then(function (result) {
                  ...
                  axios
                    .get('/api/v1/projects/'.concat(_this5.slug, '/cancel/invitation/users/').concat(userId), {
                      useProgress: true,
                    })
                    .then(function (response) {
                    ...
                    ['catch'](function (error) {
                      ...
                      _this5.$vToastify.warning(
                        ((_error$response5 = error.response) === null ||
                        _error$response5 === void 0 ||
                        (_error$response5 = _error$response5.data) === null ||
                        _error$response5 === void 0
                          ? void 0
                          : _error$response5.message) || 'Failed to cancel the request. Try again.',
                      );
                    });
                });
              },
              loadPendingRequests: function loadPendingRequests() {
                var _this6 = this;
                axios
                  .get('/api/v1/projects/'.concat(this.slug, '/pending/invitations'))
                  .then(function (response) {
                    _this6.pendingMembers = response.data.pending_invitations;
                  })
                  ['catch'](function (error) {
                    var _error$response6;
                    _this6.$vToastify.warning(
                      ((_error$response6 = error.response) === null ||
                      _error$response6 === void 0 ||
                      (_error$response6 = _error$response6.data) === null ||
                      _error$response6 === void 0
                        ? void 0
                        : _error$response6.message) || 'Failed to load pending invitations.',
                    );
                  });
              },
            },
                        ...
                        _c(
                          ...
                          [
                            _vm.isLoading
                              ...
                              : !_vm.isLoading && _vm.query && _vm.results.length === 0
                                ? _c('li', [_vm._v('\n          No users found.\n        ')])
                          ...
                          [
                            _c(
                              ...
                              [
                                _c(
                                  ...
                                  [
                                    ...
                                    _c('p', [
                                      ...
                                      _c('br'),
                                      _vm._v(' '),
                                      _c('span', [_vm._v('(' + _vm._s(member.username) + ')')]),
                                    ]),
                                    _vm._v(' '),
                                    _c('p'),
                                  ],
                                ...
                                _vm._v(' '),
                                _vm.ownerLogin && member.uuid !== _vm.owner.uuid
                                  ? _c(
                                      'a',
                                      {
                    ...
                    _c(
                      ...
                      [
                        _vm.pendingMembers.length
                          ? _vm._l(_vm.pendingMembers, function (member) {
                              return _c(
                                'div',
                                {
                                  key: member.id,
                                ...
                                [
                                  _c(
                                    ...
                                    [
                                      ...
                                      _vm._v(' '),
                                      _c('span', [_vm._v(_vm._s(member.invitation_sent_at))]),
                                      _vm._v(' '),
                                      _c('br'),
                                      _vm._v(' '),
                                      _vm.ownerLogin && member.uuid !== _vm.owner.uuid
  ...
  \************************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        'use strict';
        __webpack_require__.r(__webpack_exports__);
        /* harmony import */ var _Features_vue_vue_type_template_id_50c2fb09__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ./Features.vue?vue&type=template&id=50c2fb09 */ './resources/js/components/Project/Panel/Features.vue?vue&type=template&id=50c2fb09',
          );
        /* harmony import */ var _Features_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ./Features.vue?vue&type=script&lang=js */ './resources/js/components/Project/Panel/Features.vue?vue&type=script&lang=js',
          );
  ...
  \************************************************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Features_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! -!../../../../../node_modules/babel-loader/lib??ref--4-0!../../../../../node_modules/vue-loader/lib??vue-loader-options!./Features.vue?vue&type=script&lang=js */ './node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Project/Panel/Features.vue?vue&type=script&lang=js',
          );
        /* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__['default'] =
          _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Features_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__[
            'default'
          ];
  ...
  \******************************************************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, 'render', function () {
          return _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_Features_vue_vue_type_template_id_50c2fb09__WEBPACK_IMPORTED_MODULE_0__[
            'render'
          ];
        });
