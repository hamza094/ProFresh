(window['webpackJsonp'] = window['webpackJsonp'] || []).push([
  ...
  \*****************************************************************************************************************************************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _utils_TaskUtils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
        ...
        /* harmony import */ var _Modal_TopArea_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! ./Modal/TopArea.vue */ './resources/js/components/Project/Panel/Modal/TopArea.vue',
        );
        /* harmony import */ var _Modal_TaskDescription_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          /*! ./Modal/TaskDescription.vue */ './resources/js/components/Project/Panel/Modal/TaskDescription.vue',
        );
        /* harmony import */ var _Modal_TaskMembers_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          /*! ./Modal/TaskMembers.vue */ './resources/js/components/Project/Panel/Modal/TaskMembers.vue',
        );
        /* harmony import */ var _mixins_modalClose__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
          /*! ../../../mixins/modalClose */ './resources/js/mixins/modalClose.js',
        );
        function _typeof(o) {
        ...
        /* harmony default export */ __webpack_exports__['default'] = {
          ...
          computed: _objectSpread(
            _objectSpread(
              {},
              Object(vuex__WEBPACK_IMPORTED_MODULE_1__['mapState'])('SingleTask', [
                'task',
                'errors',
                'form',
                'statuses',
            ...
            {},
            {
              ...
              remainingTime: function remainingTime() {
                return Object(_utils_TaskUtils__WEBPACK_IMPORTED_MODULE_0__['calculateRemainingTime'])(
                  this.task,
                  this.currentDate,
                );
              },
          ...
          methods: _objectSpread(
            _objectSpread(
              _objectSpread(
                _objectSpread(
                  {},
                  Object(vuex__WEBPACK_IMPORTED_MODULE_1__['mapMutations'])('task', [
                    'removeTaskFromState',
                    'pushArchivedTask',
                    'removeArchivedTask',
                    'updateTask',
            ...
            {},
            {
              changeStatus: function changeStatus(statusId, task, id) {
                ...
                axios
                  .put(
                    Object(_utils_TaskUtils__WEBPACK_IMPORTED_MODULE_0__['url'])(this.slug, id),
                    {
                      status_id: statusId,
                    },
                    {
              ...
              unassignMember: function unassignMember(taskId, memberId) {
                ...
                axios
                  .patch(
                    Object(_utils_TaskUtils__WEBPACK_IMPORTED_MODULE_0__['url'])(this.slug, taskId) + '/unassign',
                    {
                      member: memberId,
                    },
                    {
              ...
              archive: function archive(task, taskId) {
                var _this5 = this;
                axios['delete'](
                  Object(_utils_TaskUtils__WEBPACK_IMPORTED_MODULE_0__['url'])(this.slug, taskId) + '/archive',
                  {
                    useProgress: true,
                  },
                )
              ...
              unArchive: function unArchive(task, taskId) {
                var _this6 = this;
                axios
                  .get(Object(_utils_TaskUtils__WEBPACK_IMPORTED_MODULE_0__['url'])(this.slug, taskId) + '/unarchive', {
                    useProgress: true,
                  })
                  .then(function (response) {
              ...
              trash: function trash(task, taskId) {
                var _this7 = this;
                axios['delete'](
                  Object(_utils_TaskUtils__WEBPACK_IMPORTED_MODULE_0__['url'])(this.slug, taskId) + '/remove',
                  {
                    useProgress: true,
                  },
                )
  ...
  \*************************************************************************************************************************************************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _utils_TaskUtils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          /*! ../../../../utils/TaskUtils */ './resources/js/utils/TaskUtils.js',
        );
        /* harmony import */ var _mixins_modalClose__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! ../../../../mixins/modalClose */ './resources/js/mixins/modalClose.js',
        );
        function _typeof(o) {
          '@babel/helpers - typeof';
        ...
        /* harmony default export */ __webpack_exports__['default'] = {
          ...
          methods: _objectSpread(
            _objectSpread(
              _objectSpread(
                {},
                Object(vuex__WEBPACK_IMPORTED_MODULE_0__['mapMutations'])('SingleTask', [
                  'setErrors',
                  'updateTaskTitle',
                  'setForm',
                ]),
              ),
              Object(vuex__WEBPACK_IMPORTED_MODULE_0__['mapMutations'])('task', ['updateTask']),
            ),
            {},
            {
              updateTitle: function updateTitle(id, task) {
                ...
                axios
                  .put(
                    Object(_utils_TaskUtils__WEBPACK_IMPORTED_MODULE_1__['url'])(this.slug, id),
                    {
                        ...
                        [
                          _c(
                            ...
                            [
                              _c(
                                ...
                                [
                                  ...
                                  _c(
                                    ...
                                    [_vm._v(_vm._s(_vm.task.status.label))],
                                  ),
                                  _vm._v(' '),
                                  _vm._m(1),
                                  _vm._v(' '),
                                  _vm._l(_vm.task.members, function (member) {
                                    return _c(
                                      'span',
                                      {
                                        key: member.id,
                              ...
                              _vm._v(' '),
                              (_vm$errors = _vm.errors) !== null && _vm$errors !== void 0 && _vm$errors.member
                                ? _c('span', {
                                    staticClass: 'text-danger font-italic',
                                    domProps: {
                                      textContent: _vm._s(
                                        (_vm$errors2 = _vm.errors) === null || _vm$errors2 === void 0
                                          ? void 0
                                          : _vm$errors2.member,
                                      ),
                                    },
                              ...
                              _vm.task.due_at
                                ? _c('p', [
                                    _vm._m(2),
                                    _vm._v(' ' + _vm._s(_vm.task.due_at) + ' ' + _vm._s(_vm.auth.timezone)),
                                  ])
                                : _vm._e(),
                              _vm._v(' '),
                              _vm.task.notified
                                ? _c('p', [_vm._m(3), _vm._v(_vm._s(_vm.task.notified) + ' ')])
                                : _vm._e(),
                              _vm._v(' '),
                              _vm.task.due_at
                                ? _c('p', [
                                    _c('small', [
                                      ...
                                      _vm._v(_vm._s(this.remainingTime) + '  '),
                                    ]),
                                  ])
                                : _vm._e(),
                              _vm._v(' '),
                                      ...
                                      [
                                        ...
                                        _c(
                                          ...
                                          [
                                            ...
                                            _vm._v(' '),
                                            _vm._l(_vm.due_notifies, function (notify) {
                                              return _c(
                                                'option',
                                                {
                                                  domProps: {
                                        ...
                                        _vm._v(' '),
                                        (_vm$errors3 = _vm.errors) !== null &&
                                        _vm$errors3 !== void 0 &&
                                        _vm$errors3.notified
                                          ? _c('span', {
                                              staticClass: 'text-danger font-italic',
                                              domProps: {
                                                textContent: _vm._s(
                                                  (_vm$errors4 = _vm.errors) === null ||
                                                    _vm$errors4 === void 0 ||
                                                    (_vm$errors4 = _vm$errors4.notified) === null ||
                                                    _vm$errors4 === void 0
                                                    ? void 0
                                                    : _vm$errors4[0],
                                                ),
          ...
          return _c('div', [
            _c(
              ...
              [
                ...
                _vm._v(' '),
                (_vm$errors = _vm.errors) !== null && _vm$errors !== void 0 && _vm$errors.title
                  ? _c('span', {
                      staticClass: 'text-danger font-italic',
                      domProps: {
                        textContent: _vm._s(
                          (_vm$errors2 = _vm.errors) === null ||
                            _vm$errors2 === void 0 ||
                            (_vm$errors2 = _vm$errors2.title) === null ||
                            _vm$errors2 === void 0
                            ? void 0
                            : _vm$errors2[0],
                        ),
  ...
  \*********************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        'use strict';
        __webpack_require__.r(__webpack_exports__);
        /* harmony import */ var _Modal_vue_vue_type_template_id_041ce091__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ./Modal.vue?vue&type=template&id=041ce091 */ './resources/js/components/Project/Panel/Modal.vue?vue&type=template&id=041ce091',
          );
        /* harmony import */ var _Modal_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          /*! ./Modal.vue?vue&type=script&lang=js */ './resources/js/components/Project/Panel/Modal.vue?vue&type=script&lang=js',
        );
  ...
  \*********************************************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Modal_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! -!../../../../../node_modules/babel-loader/lib??ref--4-0!../../../../../node_modules/vue-loader/lib??vue-loader-options!./Modal.vue?vue&type=script&lang=js */ './node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Project/Panel/Modal.vue?vue&type=script&lang=js',
          );
        /* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__['default'] =
          _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Modal_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__[
            'default'
          ];
  ...
  \***************************************************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, 'render', function () {
          return _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_Modal_vue_vue_type_template_id_041ce091__WEBPACK_IMPORTED_MODULE_0__[
            'render'
          ];
        });
  ...
  \*****************************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        'use strict';
        __webpack_require__.r(__webpack_exports__);
        /* harmony import */ var _TopArea_vue_vue_type_template_id_e9f8c338_scoped_true__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ./TopArea.vue?vue&type=template&id=e9f8c338&scoped=true */ './resources/js/components/Project/Panel/Modal/TopArea.vue?vue&type=template&id=e9f8c338&scoped=true',
          );
        /* harmony import */ var _TopArea_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ./TopArea.vue?vue&type=script&lang=js */ './resources/js/components/Project/Panel/Modal/TopArea.vue?vue&type=script&lang=js',
          );
        /* empty/unused harmony star reexport */ /* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! ../../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ './node_modules/vue-loader/lib/runtime/componentNormalizer.js',
  ...
  \*****************************************************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_TopArea_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! -!../../../../../../node_modules/babel-loader/lib??ref--4-0!../../../../../../node_modules/vue-loader/lib??vue-loader-options!./TopArea.vue?vue&type=script&lang=js */ './node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Project/Panel/Modal/TopArea.vue?vue&type=script&lang=js',
          );
        /* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__['default'] =
          _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_TopArea_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__[
            'default'
          ];
  ...
  \***********************************************************************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, 'render', function () {
          return _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_TopArea_vue_vue_type_template_id_e9f8c338_scoped_true__WEBPACK_IMPORTED_MODULE_0__[
            'render'
          ];
        });
  ...
  \*******************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        'use strict';
        __webpack_require__.r(__webpack_exports__);
        /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'modalClose', function () {
          return modalClose;
        });
