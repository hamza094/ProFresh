...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    updateImage: function updateImage(imageSrc) {
    ...
    uploadImage: function uploadImage() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var canvas, blob, formData;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this2.$vToastify.loader("Please Wait Avatar Uploading");
                canvas = _this2.$refs.cropper.getCroppedCanvas();
                _context.next = 4;
              ...
              case 4:
                ...
                axios.post("/api/v1/users/" + _this2.userId + "/avatar", formData).then(function (response) {
                  _this2.$bus.emit('userAvatar', {
                    avatar: response.data.avatar
                  });
                  _this2.closeAvatarModal();
                  _this2.$vToastify.success("Avatar Updated Successfully");
                })["catch"](function (error) {
                  _this2.$vToastify.warning("Failed To Update Avatar");
                })["finally"](function () {
                  _this2.$vToastify.stopLoader();
                });
              case 8:
              case "end":
...
var render = function render() {
  ...
  return _c("div", {
    ...
    on: {
      click: _vm.showAvatarModal
    }
  }, [!this.avatar ? _c("div", {
    staticClass: "img-avatar_name"
  }, [_vm._v("\n            " + _vm._s(this.name.substring(0, 1)) + "\n        ")]) : _c("div", [_c("img", {
  ...
  }), _vm._v(" "), _vm.imageSrc ? _c("img", {
    attrs: {
      src: _vm.imageSrc,
      width: "100"
    }
  }) : _vm._e(), _vm._v(" "), this.imageSrc ? _c("div", {
  ...
  }, [_vm._v("\n                Crop\n            ")]) : _vm._e(), _vm._v(" "), this.croppedImageSrc ? _c("button", {
