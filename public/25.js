...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_3__["mapState"])('meeting', ['meetings', 'message'])),
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _this.loadingId = _this.$vToastify.loader('Initializing meeting. Please hold on...');
              _context.prev = 1;
              role = _this.auth.id === meeting.owner.id ? 1 : 0;
              _context.next = 5;
              return Object(_utils_zoomUtils__WEBPACK_IMPORTED_MODULE_4__["fetchTokens"])(action, role, meeting.meeting_id, _this.$vToastify);
            case 5:
              ...
              _context.next = 13;
              return Object(_utils_zoomUtils__WEBPACK_IMPORTED_MODULE_4__["setupAndJoinMeeting"])(action, meeting, jwt_token, zak_token, _this.auth);
            case 13:
              _this.$vToastify.success('Meeting initiated successfully!');
              _context.next = 19;
              break;
            case 16:
              _context.prev = 16;
              _context.t0 = _context["catch"](1);
              _this.$vToastify.error('Meeting initiated failed!');
            case 19:
              _context.prev = 19;
              _this.$vToastify.stopLoader(_this.loadingId);
...
var render = function render() {
  ...
  return _c("div", [_c("div", {
    ...
    })])])]), _vm._v(" "), meeting.status === "Started" ? _c("div", {
    ...
    }, [!_vm.notAuthorize && meeting.owner.id === _vm.auth.id && meeting.status !== "Started" ? _c("button", {
      staticClass: "btn btn-sm btn-primary",
      on: {
        click: function click($event) {
          $event.preventDefault();
    ...
    }, [_vm._v("\n                      Start Meeting\n                    ")]) : meeting.owner.id !== _vm.auth.id && _vm.members.includes(_vm.auth) ? _c("button", {
