...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_3__["mapMutations"])('project', ['removeTaskFromState', 'pushArchivedTask', 'removeArchivedTask', 'pushTask'])), {}, {
    ...
    archive: function archive(task, taskId) {
      ...
      axios["delete"]("/api/v1/projects/".concat(this.slug, "/tasks/").concat(taskId, "/archive")).then(function (response) {
        _this9.$vToastify.warning(response.data.message);
        _this9.removeTaskFromState(taskId);
        _this9.pushArchivedTask(task);
        _this9.modalClose();
      })["catch"](function (error) {
        console.log(error);
      });
    ...
    unArchive: function unArchive(task, taskId) {
      var _this10 = this;
      axios.get("/api/v1/projects/".concat(this.slug, "/tasks/").concat(taskId, "/unarchive")).then(function (response) {
        _this10.$vToastify.success(response.data.message);
        _this10.removeArchivedTask(taskId);
        _this10.pushTask(task);
        _this10.modalClose();
      })["catch"](function (error) {
        console.log(error);
      });
    ...
    trash: function trash(task, taskId) {
      var _this11 = this;
      axios["delete"]("/api/v1/projects/".concat(this.slug, "/tasks/").concat(taskId, "/delete")).then(function (response) {
        _this11.$vToastify.success(response.data.message);
        _this11.removeArchivedTask(taskId);
        _this11.modalClose();
      })["catch"](function (error) {
        console.log(error);
      });
