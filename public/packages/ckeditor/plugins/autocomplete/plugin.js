...
(function () {
  function d(a, b) {
    ...
    this.followingSpace = b.followingSpace;
  ...
  function l(a) {
    var b = a
      ...
      .getNextNode(function (a) {
        return Boolean(a.type == CKEDITOR.NODE_TEXT && a.getText());
      });
    b && b.getText().match(/^\s+/) && ((a = a.createRange()), a.setStart(b, 0), a.setEnd(b, 1), a.deleteContents());
  }
  ...
  d.prototype = {
    attach: function () {
      var a = this.editor,
        ...
        c = a.editable(),
        k = c.isInline() ? c : c.getDocument();
      CKEDITOR.env.iOS && !c.isInline() && (k = a.window.getFrame().getParent());
      this.view.append();
      this.view.attach();
      ...
      c && (this.registerPanelNavigation(), this.addAriaAttributesToEditable());
      a.on(
        'contentDom',
        function () {
    ...
    addAriaAttributesToEditable: function () {
      var a = this.editor.editable(),
        b = this.view.element.getAttribute('id');
      a.isInline() &&
    ...
    updateAriaAttributesOnEditable: function (a) {
      var b = this.editor.editable();
      a = a.data;
      b &&
        b.isInline() &&
        (b.setAttribute('aria-expanded', a ? 'true' : 'false'), a || b.setAttribute('aria-activedescendant', ''));
    },
    updateAriaActiveDescendantAttributeOnEditable: function (a) {
      var b = this.editor.editable();
      b.isInline() && b.setAttribute('aria-activedescendant', a);
    },
    removeAriaAttributesFromEditable: function () {
      var a = this.editor.editable();
      a &&
        a.isInline() &&
        (a.removeAttributes(['aria-controls', 'aria-expanded', 'aria-activedescendant']),
        a.setAttribute('aria-autocomplete', 'none'));
    },
    close: function () {
    ...
    commit: function (a) {
      if (this.model.isActive) {
        ...
        var b = this.model.getItemById(a);
        a = this.editor;
        b = this.getHtmlToInsert(b);
        b += this.followingSpace ? '\x26nbsp;' : '';
        a.fire('saveSnapshot');
        a.getSelection().selectRanges([this.model.range]);
        a.insertHtml(b, 'text');
        this.followingSpace && l(a);
        a.fire('saveSnapshot');
      }
    },
    destroy: function () {
    ...
    getModel: function (a) {
      ...
      return new f(function (c, k) {
        return a.call(this, CKEDITOR.tools.extend({ autocomplete: b }, c), k);
      });
    },
    ...
    onSelectedItemId: function (a) {
      a = a.data;
      var b = this.view.getItemById(a);
      this.model.setItem(a);
      this.view.selectItem(a);
      this.updateAriaActiveDescendantAttributeOnEditable(b.getAttribute('id'));
    },
  ...
  g.prototype = {
    ...
    createItem: function (a) {
      a = h(a);
      a = CKEDITOR.dom.element.createFromHtml(this.itemTemplate.output(a), this.document);
    ...
    setPosition: function (a) {
      var b = this.element.getWindow(),
        c = b.getViewPaneSize(),
        b = (function (a) {
          var b = a.editorViewportRect,
            c = a.caretRect,
            e = a.viewHeight,
            d = a.scrollPositionY,
            g = a.windowHeight;
          if (b.bottom < c.bottom) return Math.min(c.top, b.bottom) - e;
          a = c.top - b.top;
          var f = b.bottom - c.bottom,
            h = c.top - e < d;
          if (e > f && e < a && !h) return c.top - e;
          if (b.top > c.top) return Math.max(c.bottom, b.top);
          d = c.bottom + e > g + d;
          return (e > f && e < a) || !d ? Math.min(b.bottom, c.bottom) : c.top - e;
        })({
          editorViewportRect: (function (a) {
            var b = a.editable();
            return CKEDITOR.env.iOS && !b.isInline()
              ? a.window.getFrame().getParent().getClientRect(!0)
              : b.isInline()
                ? b.getClientRect(!0)
                : a.window.getFrame().getClientRect(!0);
          })(this.editor),
          caretRect: a,
          viewHeight: this.element.getSize('height'),
          scrollPositionY: b.getScrollPosition().y,
          windowHeight: c.height,
        });
      a = (function (a) {
        var b = a.leftPosition,
          c = a.viewWidth;
        a = a.windowWidth;
        return b + c > a ? a - c : b;
      })({ leftPosition: a.left, viewWidth: this.element.getSize('width'), windowWidth: c.width });
      this.element.setStyles({ left: a + 'px', top: b + 'px' });
    },
  ...
  CKEDITOR.plugins.autocomplete = d;
  d.view = g;
  d.model = f;
