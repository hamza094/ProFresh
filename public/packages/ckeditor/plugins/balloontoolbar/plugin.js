    ...
    init: function (a) {
      ...
      m ||
        ...
        (CKEDITOR.ui.balloonToolbarView.prototype.reposition = function () {
          this.rect.visible && this.attach(this._pointedElement, { focusElement: !1 });
        }),
        ...
        (CKEDITOR.ui.balloonToolbarView.prototype.renderItems = function (a) {
          ...
          CKEDITOR.tools.array.forEach(
            f,
            function (e) {
              CKEDITOR.ui.richCombo && a[e] instanceof CKEDITOR.ui.richCombo && d
                ? ((d = !1), c.push('\x3c/span\x3e'))
                : (CKEDITOR.ui.richCombo && a[e] instanceof CKEDITOR.ui.richCombo) ||
                  d ||
