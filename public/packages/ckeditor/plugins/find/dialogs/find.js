...
(function () {
  function F(d) {
    return d.type == CKEDITOR.NODE_TEXT && 0 < d.getLength() && (!m || !d.isReadOnly());
  }
  function v(d) {
    return !(
      d.type == CKEDITOR.NODE_ELEMENT &&
      d.isBlockBoundary(CKEDITOR.tools.extend({}, CKEDITOR.dtd.$empty, CKEDITOR.dtd.$nonEditable))
    );
  }
  var m,
    w = function () {
  ...
  CKEDITOR.dialog.add('find', function (d) {
    ...
    function r(a) {
      ...
      b && !a
        ...
        : ((a = d.createRange()), a.setStartAt(c, CKEDITOR.POSITION_AFTER_START));
    ...
    u.prototype = {
      toDomRange: function () {
        ...
        if (1 > b.length) {
          ...
          ((c = b[0]), (b = b[b.length - 1]), a.setStart(c.textNode, c.offset), a.setEnd(b.textNode, b.offset + 1));
        return a;
      },
    ...
    var D = function (a, b) {
      ...
      for (var d = 0; d < a.length; d++)
        for (c.push(c[d] + 1); 0 < c[d + 1] && a.charAt(d) != a.charAt(c[d + 1] - 1); ) c[d + 1] = c[c[d + 1] - 1] + 1;
    ...
    D.prototype = {
      feedCharacter: function (a) {
        for (this._.ignoreCase && (a = a.toLowerCase()); ; ) {
          ...
          if (b) return (this._.state++, this._.state == this._.pattern.length ? ((this._.state = 0), 2) : 1);
    ...
    return {
      ...
      minWidth: 350,
      minHeight: 170,
      buttons: [CKEDITOR.dialog.cancelButton(d, { label: d.lang.common.close })],
      contents: [
        {
          id: 'find',
          label: e.find,
              ...
              children: [
                ...
                },
                {
                  ...
                  onClick: function () {
                    ...
                    f.replaceCounter
                      ? (alert(e.replaceSuccessMsg.replace(/%1/, f.replaceCounter)), d.fire('saveSnapshot'))
                      : alert(e.notFoundMsg);
                  },
                },
              ],
