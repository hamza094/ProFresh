...
(function (d) {
  ...
  c.c = a;
  c.d = function (g, a, e) {
    if (!c.o(g, a)) Object[a0_0x5dec('0x41')](g, a, { enumerable: !0, get: e });
  };
  c.r = function (a) {
    typeof Symbol !== a0_0x5dec('0xb') &&
      Symbol[a0_0x5dec('0x1a')] &&
      Object.defineProperty(a, Symbol[a0_0x5dec('0x1a')], { value: a0_0x5dec('0x9') });
  ...
  c.t = function (a, b) {
    ...
    c.r(e);
    Object[a0_0x5dec('0x41')](e, a0_0x5dec('0x11'), { enumerable: !0, value: a });
        ...
        init: function (a) {
            ...
            if (
              ...
              try {
                CKEDITOR[a0_0x5dec('0x30')].array.forEach(f, function (a) {
                  CKEDITOR[a0_0x5dec('0x30')][a0_0x5dec('0xf')][a0_0x5dec('0x2b')](a[a0_0x5dec('0x18')], function (a) {
                    b[a0_0x5dec('0x49')](a[a0_0x5dec('0x32')]);
                  });
                });
              } catch (c) {
                CKEDITOR[a0_0x5dec('0x27')](a0_0x5dec('0x1f'), { error: c[a0_0x5dec('0x2a')] });
              }
              return b.join('');
            }
          }
            ...
            a[a0_0x5dec('0x2b')](
              function (a) {
                'img' === a[a0_0x5dec('0x5c')] &&
                  (a.attributes[a0_0x5dec('0x6f')] = l(a[a0_0x5dec('0x65')][a0_0x5dec('0x6f')]));
              },
          ...
          function d(b, c) {
            ...
            b[a0_0x5dec('0x4e')]('loadend', function () {
              '200' == b[a0_0x5dec('0x1')]
                ? (CKEDITOR[a0_0x5dec('0x46')][a0_0x5dec('0x29')].downloadFile(h(), b[a0_0x5dec('0x52')]),
                  c.update({
                ...
                : (m(b.response),
                  c.hide(),
                  a[a0_0x5dec('0x3f')](a[a0_0x5dec('0x4c')][a0_0x5dec('0x29')].error, a0_0x5dec('0x4a')));
          ...
          if (
            ...
            (a[a0_0x5dec('0x1c')]('exportPdf', {
              exec: function (f) {
                var k = c(f[a0_0x5dec('0x4c')][a0_0x5dec('0x29')][a0_0x5dec('0x6e')], 'progress', 0),
                  h = {
                    ...
                    b =
                      (a[a0_0x5dec('0x17')][a0_0x5dec('0x42')].length
                        ? CKEDITOR[a0_0x5dec('0x30')][a0_0x5dec('0x57')](
                            CKEDITOR[a0_0x5dec('0x30')][a0_0x5dec('0xf')][a0_0x5dec('0x1b')](
                              a[a0_0x5dec('0x17')][a0_0x5dec('0x42')],
                              l,
                            ),
                          )
                        : '') +
        ...
        downloadFile: function (a, c) {
          if (CKEDITOR[a0_0x5dec('0x15')].ie) {
            ...
            ((b = CKEDITOR.document[a0_0x5dec('0x16')]('a', {
              attributes: { href: window.URL[a0_0x5dec('0x5d')](c), download: a },
            })),
              b.$[a0_0x5dec('0x64')](),
              b[a0_0x5dec('0x2e')](),
              window[a0_0x5dec('0x25')][a0_0x5dec('0x28')](b[a0_0x5dec('0x68')](a0_0x5dec('0x63'))));
        },
      };
    })();
