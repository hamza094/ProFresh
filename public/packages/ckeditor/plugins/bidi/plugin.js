...
(function () {
  ...
  function w(a) {
    ...
    return function (c, h) {
      if (!this.isReadOnly()) {
        var d;
        if ((d = c == (f || e ? 'dir' : 'direction') || ('style' == c && (e || b.test(h))))) {
          a: {
            d = this;
        ...
        if (d && ((d = this.getDirection(1)), (g = a.apply(this, arguments)), d != this.getDirection(1)))
  ...
  CKEDITOR.plugins.add('bidi', {
    ...
    init: function (a) {
      function f(b, c, e, d, f) {
        ...
        a.ui.addButton && a.ui.addButton(b, { isToggle: !0, label: c, command: e, toolbar: 'bidi,' + f });
      }
      if (!a.blockless) {
        var e = a.lang.bidi;
