  ...
  function G() {
    ...
    a !== y.data.src
      ? (H(a, function (a, c, d) {
          u(!0);
          if (!a) return p(f ? b : !1);
          h.setValue(!1 === e.config.image2_prefillDimensions ? 0 : c);
          k.setValue(!1 === e.config.image2_prefillDimensions ? 0 : d);
          v = m = c;
          w = n = d;
        ...
        (q = !0))
      : q
        ? (u(!0), h.setValue(m), k.setValue(n), (q = !1))
        : u(!0);
  }
  function J() {
    if (d) {
        ...
        elements: [
          {
            type: 'vbox',
            padding: 0,
            children: [{ type: 'hbox', widths: ['100%'], className: 'cke_dialog_image_url', children: N }],
          },
          {
            id: 'alt',
            type: 'text',
