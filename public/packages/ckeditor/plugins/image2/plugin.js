...
(function () {
    ...
    function h() {
      ...
      if (this.deflated)
        ...
        if (d) {
          ...
          'center' == b ? f && c.addClass(d[1]) : 'none' != b && c.addClass(d[p[b]]);
        } else
          'center' == b
            ? (f ? c.setStyle('text-align', 'center') : c.removeStyle('text-align'), c.removeStyle('float'))
            : ('none' == b ? c.removeStyle('float') : c.setStyle('float', b), c.removeStyle('text-align'));
      }
    }
    ...
    return {
      ...
      init: function () {
        var d = CKEDITOR.plugins.image2,
          c = this.parts.image,
          b = this.ready ? d.checkHasNaturalRatio(c) : !0,
          b = {
            ...
            lock: void 0 !== a.config.image2_defaultLockRatio ? a.config.image2_defaultLockRatio : b,
          },
          h = c.getAscendant('a');
        ...
        b.align ||
          ...
          e
            ? (c.hasClass(e[0]) ? (b.align = 'left') : c.hasClass(e[2]) && (b.align = 'right'),
              b.align ? c.removeClass(e[p[b.align]]) : (b.align = 'none'))
            : ((b.align = c.getStyle('float') || 'none'), c.removeStyle('float')));
        a.plugins.link &&
          this.parts.link &&
        ...
        this.setData(b);
        a.filter.checkFeature(this.features.dimension) && !0 !== a.config.image2_disableResizer && I(this);
      ...
      getClasses: (function () {
        ...
        return function () {
          var b = this.repository.parseElementClasses(q(this).getAttribute('class')),
            e;
  ...
  function J(a) {
    ...
    return function (a, g) {
      ...
      if (
        ...
        (b(a)
          ? ('div' == c && (f = a.getFirst('figure')) && (a.replaceWith(f), (a = f)),
            (g.align = 'center'),
        ...
        for (var D in d) (d = f.attributes[D]) && d.match(L) && delete f.attributes[D];
        return a;
      }
    };
  }
    ...
    return function (a) {
      ...
      d &&
        ...
        'center' == d && 'figure' == a.name
          ...
          : d in { left: 1, right: 1 } && (b ? e.addClass(b[p[d]]) : (c['float'] = d)),
  ...
  function r(a) {
    ...
    return function (g) {
      ...
      return (
        h ? g.hasClass(h[1]) : 'center' == CKEDITOR.tools.parseCssText(g.attributes.style || '', !0)['text-align']
      )
        ? !0
        : !1;
    };
    ...
    g.on('mousedown', function (c) {
      ...
      d(
        ...
        function (a) {
          ...
          15 > u || 15 > v || a || ((z = { width: u, height: v }), f.setAttributes(z));
        },
        m,
      );
      d(
    ...
    return function (e) {
      ...
      if (g) {
        ...
        g.on('refresh', function (b) {
          ...
          c &&
            (void 0 === h && (h = a.filter.checkFeature(a.widgets.registered.image.features.align)),
            h
              ? this.setState(
                  c.data.align == e
  ...
  CKEDITOR.plugins.add('image2', {
    ...
    init: function (a) {
      if (!a.plugins.detectConflict('image2', ['easyimage'])) {
        ...
        a.contextMenu &&
          (a.addMenuGroup('image', 10), a.addMenuItem('image', { label: h.menu, command: 'image', group: 'image' }));
  ...
  CKEDITOR.plugins.image2 = {
    stateShifter: function (a) {
      function b(a, b) {
        ...
        c = e.createElement(a.activeEnterMode == CKEDITOR.ENTER_P ? 'p' : 'div', c);
        h(c, b);
        b.move(c);
        return c;
      }
      ...
      var e = a.document,
        ...
        k = {
            ...
            b.changed.hasCaption &&
              ...
              f
                ? ((f = CKEDITOR.dom.element.createFromHtml(
                    P.output({ captionedClass: d, captionPlaceholder: a.lang.image2.captionPlaceholder }),
                    e,
                  )),
                  h(f, b.element),
          ...
          link: function (b, c, d) {
            if (b.changed.link) {
              var f = b.element.is('img') ? b.element : b.element.findOne('img'),
              ...
              d
                ? (c ||
                    ((k = e.createElement('a', { attributes: { href: b.newData.link.url } })), k.replace(f), f.move(k)),
      ...
      return function (a) {
        var b, c;
        a.changed = {};
        for (c = 0; c < f.length; c++) ((b = f[c]), (a.changed[b] = a.oldData ? a.oldData[b] !== a.newData[b] : !1));
        for (c = 0; c < f.length; c++) ((b = f[c]), k[b](a, a.oldData ? a.oldData[b] : null, a.newData[b]));
        a.inflate();
      };
    },
