              ...
              ((f = c[h]),
                ...
                -1 === l(b.preservedElements, f.element)
                  ? CKEDITOR.env.webkit && !CKEDITOR.env.chrome
                    ...
                    : c[h].remove(e.editor)
                  : u(f.element, e.data.styles) && b._removeStylesFromElementInRange(d, f.element),
                d.moveToBookmark(g));
        }
      });
      a.copyFormatting.on(
        ...
        function (b) {
          ...
          'list' === c && a.copyFormatting._isContextAllowed('list')
            ...
            : 'table' === c && a.copyFormatting._isContextAllowed('table')
              ? d._applyStylesToTableContext(b.editor, b.data.range, b.data.styles)
              : a.copyFormatting._isContextAllowed('text') &&
                d._applyStylesToTextContext(b.editor, b.data.range, b.data.styles);
        },
        null,
        null,
        999,
  ...
  CKEDITOR.plugins.copyformatting = {
    ...
    _extractStylesFromElement: function (a, b) {
      ...
      do
        if (
          ...
          ((e.element = b),
          a.copyFormatting.fire('extractFormatting', e, a) && e.styleDef && d.push(new CKEDITOR.style(e.styleDef)),
    ...
    _extractStylesFromRange: function (a, b) {
      for (var e = [], d = new CKEDITOR.dom.walker(b), c; (c = d.next()); )
        e = e.concat(CKEDITOR.plugins.copyformatting._extractStylesFromElement(a, c));
      return e;
    },
    _removeStylesFromElementInRange: function (a, b) {
      for (var e = -1 !== l(['ol', 'ul', 'table'], b), d = new CKEDITOR.dom.walker(a), c; (c = d.next()); )
        if ((c = c.getAscendant(b, !0))) if ((c.removeAttributes(c.getAttributes()), e)) break;
    },
    ...
    _filterStyles: function (a) {
      ...
      for (c = 0; c < a.length; c++)
        ((d = a[c]._.definition),
          -1 !== CKEDITOR.tools.indexOf(CKEDITOR.plugins.copyformatting.inlineBoundary, d.element) &&
            (d.element = a[c].element = 'span'),
          ('span' === d.element && b(d.attributes) && b(d.styles)) || e.push(a[c]));
      return e;
    },
        ...
        ((d = e[f]),
          ...
          'ol' === d.element || 'ul' === d.element
            ...
            : 'li' === d.element
              ...
              : CKEDITOR.plugins.copyformatting._applyStylesToTextContext(a, b, [d]),
          b.moveToBookmark(c));
    },
