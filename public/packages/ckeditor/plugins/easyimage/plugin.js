  ...
  function p(a, c) {
    function b(a) {
      return function (b, c) {
        ...
        e && 'easyimage' === e.name && (h = a && a.call(this, e, b, c) ? CKEDITOR.TRISTATE_ON : CKEDITOR.TRISTATE_OFF);
        this.setState(h);
      };
    }
    function f(a, c, d, e) {
    ...
    (function (b) {
      ...
      a.on('afterCommandExec', function (e) {
        c(e.data.name, b) && (a.forceNextSelectionCheck(), a.selectionChange(!0));
      });
      a.on('beforeCommandExec', function (e) {
        c(e.data.name, b) && e.data.command.style.checkActive(e.editor.elementPath(), a) && (e.cancel(), a.focus());
      });
  ...
  function t(a, c) {
    var b = a.config,
      ...
      b = {
        ...
        upcasts: {
          figure: function (a) {
            if ((!f || a.hasClass(f)) && 1 === a.find('img', !0).length) return a;
          },
        },
        init: function () {
          function b(a, c) {
    ...
    f &&
      ((b.requiredContent += '(!' + f + ')'),
      (b.allowedContent.figure.classes = '!' + f + ',' + b.allowedContent.figure.classes));
      ...
      if (!a.isReadOnly && c.test(b.data.dataValue)) {
        ...
        for (m = 0; m < e.count(); m++) {
          ...
          k &&
            ...
            !h.isReadOnly(1) &&
            (l++,
            1 < l && ((k = a.getSelection().getRanges()), k[0].enlarge(CKEDITOR.ENLARGE_ELEMENT), k[0].collapse(!1)),
            d.match(/image\/([a-z]+?);/i),
        ...
        c.once('change', function (b) {
          ...
          b.$.files.length &&
            a.fire('paste', {
              method: 'paste',
              dataValue: '',
              dataTransfer: new CKEDITOR.plugins.clipboard.dataTransfer({ files: b.$.files, types: ['Files'] }),
            });
        });
        c.$.click();
      },
  ...
  CKEDITOR.plugins.add('easyimage', {
    ...
    init: function (a) {
      this.isSupportedEnvironment() &&
        (n || (CKEDITOR.document.appendStyleSheet(this.path + 'styles/easyimage.css'), (n = !0)),
