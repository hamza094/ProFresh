...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapMutations"])('profile', ['updateUserAvatar'])), {}, {
          ...
          while (1) switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              axios.post("/api/v1/users/" + _this2.userId + "/avatar", formData).then(function (response) {
                _this2.updateUserAvatar(response.data.avatar);
