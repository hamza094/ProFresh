  ...
  <div class="card mt-4 twofa-card" role="region" aria-labelledby="twofa-title">
    ...
    <div class="card-body" v-if="!loading">
      ...
      <section v-if="isInProgress || isEnabled" class="mb-4" aria-label="2FA Setup Progress">
        <div class="stepper d-flex align-items-center" role="progressbar" aria-valuenow="1" aria-valuemin="1" aria-valuemax="2">
          <!-- Step 1: Setup -->
          <div 
            :class="['step', isEnabled ? 'completed' : (isInProgress ? 'active' : '')]" 
      ...
      <section v-if="isEnabled" aria-label="2FA Enabled Status">
        ...
        <div class="alert alert-info mb-4" role="alert">
          <div class="d-flex">
            ...
            <div>
              ...
              <p class="mb-3">Your account is now protected with an additional security layer. Here's what you need to know:</p>
              <ul class="mb-0 small">
                <li><strong>Authenticator App:</strong> Use your authenticator app (Google Authenticator, Authy, etc.) to generate 6-digit codes for login</li>
                <li><strong>Recovery Codes:</strong> Store your recovery codes securely - they're your backup access method if you lose your device</li>
        ...
        <section class="mb-4" aria-label="Recovery Codes Management">
          <div class="d-flex align-items-center mb-3">
            <h6 class="mb-0 me-2">
              ...
              <i 
                ...
                aria-label="Information about recovery codes"
              ></i>
            </h6>
            <button 
          ...
          <div class="d-flex gap-2 flex-wrap">
            ...
            >
              <span v-if="regenerateLoading" class="spinner-border spinner-border-sm me-1" role="status" aria-hidden="true"></span>
            ...
            >
              <span v-if="disableLoading" class="spinner-border spinner-border-sm me-1" role="status" aria-hidden="true"></span>
      ...
      <section v-else-if="isInProgress" aria-label="2FA Setup in Progress">
        ...
        <div class="mb-4">
          <p class="text-muted">
            ...
            Two-Factor Authentication setup is <strong>in progress</strong>. 
        ...
        <form @submit.prevent="verify2FA" class="mb-3" aria-label="2FA verification form">
          ...
          >
            <span v-if="verifyLoading" class="spinner-border spinner-border-sm me-2" role="status" aria-hidden="true"></span>
...
export default {
  ...
  data() {
    return {
      ...
      recoveryCodesTooltip: 'These are one-time use codes you can use to access your account if you lose access to your authenticator app. Store them securely.',
    };
  },
  computed: {
