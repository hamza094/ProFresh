        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-1 panel-left">
                    <div class="panel">
                        <a href="/dashboard"><img src="https://www.perfectviewcrm.com/wp-content/uploads/sites/7/2018/08/PerfectView-What-is-CRM.png" class="main-img" alt=""></a>
                        ...
                        @if(Auth::user())
                            ...
                            <router-link to="/leads" class="panel-list_item">
                                <p><span class="icon"><i class="icon-logo far fa-user-circle"></i><span class="icon-name">Leads</span></span></p>
                            </router-link>
