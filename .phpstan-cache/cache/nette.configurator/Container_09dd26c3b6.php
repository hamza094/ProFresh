...
class Container_09dd26c3b6 extends _PHPStan_b22655c3f\Nette\DI\Container
{
	protected $tags = [
		...
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper(
			...
			[
				...
				[
					...
					'count' => 1,
					'path' => 'D:\apps\profresh\app\Console\Commands\RemoveAbondonProjects.php',
				],
				[
				...
				[
					...
					'count' => 2,
					'path' => 'D:\apps\profresh\app\Exports\ProjectsExport.php',
				],
				[
				...
				[
					...
					'count' => 1,
					'path' => 'D:\apps\profresh\app\Http\Controllers\Api\V1\FeaturesController.php',
				],
				[
				...
				[
					...
					'count' => 1,
					'path' => 'D:\apps\profresh\app\Http\Views\Composers\ProjectComposer.php',
				],
				[
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_09dd26c3b6 $container)
			{
	...
	public function createServiceContainer(): Container_09dd26c3b6
	{
		return $this;
	}
