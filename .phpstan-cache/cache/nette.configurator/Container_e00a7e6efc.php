...
class Container_e00a7e6efc extends _PHPStan_b22655c3f\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_e00a7e6efc $container)
			{
	...
	public function createServiceContainer(): Container_e00a7e6efc
	{
		return $this;
	}
