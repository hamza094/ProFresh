...
final class ProjectMetricsDto
{
     ...
     * @param array|null $upcomingRisk Risk details (keys: score, at_risk_count, due_soon_count)
     * @param array|null $stageProgress Stage progress details (keys: percentage, current_stage, status, stage_id)
